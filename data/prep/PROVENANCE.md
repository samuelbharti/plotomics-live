...
| `visium_spots.csv`, `visium_expr.csv`, `www/spatial/visium_he.png` | 3,798 capture spots with coordinates and graph-based cluster, a 60-gene marker panel as log1p CP10K, and the low-res H&E | 10x Genomics, Human Breast Cancer (Block A Section 1), Visium v1.1.0. CC BY 4.0 | `Rscript data/prep/prepare-visium.R` |
